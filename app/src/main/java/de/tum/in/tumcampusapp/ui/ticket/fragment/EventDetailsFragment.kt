package de.tum.`in`.tumcampusapp.ui.ticket.fragment
...
import de.tum.`in`.tumcampusapp.ui.calendar.CreateEventActivity
import de.tum.`in`.tumcampusapp.ui.ticket.EventsController
import de.tum.`in`.tumcampusapp.ui.ticket.activity.BuyTicketActivity
import de.tum.`in`.tumcampusapp.ui.ticket.activity.ShowTicketActivity
