...
import de.tum.`in`.tumcampusapp.ui.settings.UserPreferencesActivity
import de.tum.`in`.tumcampusapp.ui.calendar.CalendarActivity
import de.tum.`in`.tumcampusapp.ui.feedback.FeedbackActivity
import de.tum.`in`.tumcampusapp.ui.grades.GradesActivity
import de.tum.`in`.tumcampusapp.ui.lectures.activity.LecturesPersonalActivity
import de.tum.`in`.tumcampusapp.ui.person.PersonSearchActivity
import de.tum.`in`.tumcampusapp.ui.roomfinder.RoomFinderActivity
import de.tum.`in`.tumcampusapp.ui.tutionfees.TuitionFeesActivity
import de.tum.`in`.tumcampusapp.ui.barrierfree.BarrierFreeInfoActivity
import de.tum.`in`.tumcampusapp.ui.cafeteria.activity.CafeteriaActivity
import de.tum.`in`.tumcampusapp.ui.chat.activity.ChatRoomsActivity
import de.tum.`in`.tumcampusapp.ui.news.NewsActivity
import de.tum.`in`.tumcampusapp.ui.openinghour.OpeningHoursListActivity
import de.tum.`in`.tumcampusapp.ui.overview.InformationActivity
import de.tum.`in`.tumcampusapp.ui.overview.MainActivity
import de.tum.`in`.tumcampusapp.ui.studyroom.StudyRoomsActivity
import de.tum.`in`.tumcampusapp.ui.ticket.activity.EventsActivity
