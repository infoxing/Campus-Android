...
import de.tum.`in`.tumcampusapp.ui.generic.adapter.EqualSpacingItemDecoration
import de.tum.`in`.tumcampusapp.ui.ticket.EventsController
import de.tum.`in`.tumcampusapp.ui.ticket.EventsViewModel
import de.tum.`in`.tumcampusapp.ui.ticket.adapter.EventsAdapter
