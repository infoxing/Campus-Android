package de.tum.`in`.tumcampusapp.ui.generic.activity
...
import de.tum.`in`.tumcampusapp.ui.generic.drawer.DrawerMenuHelper
import de.tum.`in`.tumcampusapp.navigation.NavigationManager
import de.tum.`in`.tumcampusapp.ui.onboarding.WizNavStartActivity
