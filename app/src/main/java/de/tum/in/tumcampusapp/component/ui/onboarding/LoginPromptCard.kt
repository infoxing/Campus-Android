...
class LoginPromptCard(context: Context) : Card(CardManager.CARD_LOGIN, context, "card_login") {
    ...
    public override fun discard(editor: SharedPreferences.Editor) =
            Utils.setSetting(this.context, CardManager.SHOW_LOGIN, false)

    override fun shouldShow(prefs: SharedPreferences): Boolean {
        // show on top as long as user hasn't swiped it away and isn't connected to TUMonline
        return Utils.getSettingBool(this.context, CardManager.SHOW_LOGIN, true)
    ...
    companion object : CardAdapter.CardViewHolderFactory {
        override fun inflateViewHolder(parent: ViewGroup, viewType: Int): CardViewHolder {
            ...
            view.findViewById<View>(R.id.loginButton)
                    .setOnClickListener {
