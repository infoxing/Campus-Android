package de.tum.`in`.tumcampusapp.ui.transportation.widget
...
import de.tum.`in`.tumcampusapp.ui.generic.activity.ActivityForSearching
import de.tum.`in`.tumcampusapp.ui.generic.adapter.NoResultsAdapter
import de.tum.`in`.tumcampusapp.ui.transportation.MVVStationSuggestionProvider
