...
public class AuthenticationManager {
    ...
    private final FcmUploader mFcmUploader;

    public AuthenticationManager(Context c) {
        this(c, null);
    }

    public AuthenticationManager(Context c, FcmUploader fcmUploader) {
        mContext = c;
        mFcmUploader = fcmUploader;
    }
    ...
    public void tryToUploadFcmToken() {
        mFcmUploader.tryToUploadFcmToken(mContext);
    }
